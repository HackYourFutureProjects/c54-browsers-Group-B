...
export const quizData = {
  ...
  questions: [
    // EASY
    {
      ...
      correct: 'a',
      selected: null,
      links: [{ text: 'Wikipedia', href: 'https://en.wikipedia.org/wiki/Paris' }],
    },
    {
      id: "Q2",
      difficulty: 'easy',
      ...
      correct: 'b',
      selected: null,
      links: [{ text: 'NASA', href: 'https://solarsystem.nasa.gov/planets/mars/overview/' }],
    },
    {
      id: "Q3",
      difficulty: 'easy',
    ...
    // MEDIUM
    {
      ...
      correct: 'a',
      selected: null,
      links: [{ text: 'Biography', href: 'https://www.biography.com/writer/william-shakespeare' }],
    },
    {
      id: "Q5",
      difficulty: 'medium',
      ...
      correct: 'b',
      selected: null,
      links: [{ text: 'Britannica', href: 'https://www.britannica.com/science/photosynthesis' }],
    },
    {
      id: "Q6",
      difficulty: 'medium',
      ...
      selected: null,
      links: [
        { text: 'History', href: 'https://www.history.com/topics/world-war-ii/world-war-ii-history' },
      ],
    },
    ...
    // HARD
    {
      ...
      correct: 'b',
      selected: null,
      links: [{ text: 'Louvre Museum', href: 'https://www.louvre.fr/en/explore/the-palace/mona-lisa' }],
    },
    {
      id: "Q8",
      difficulty: 'hard',
    ...
    },
    {
      ...
      correct: 'b',
      selected: null,
      links: [{ text: 'Periodic Table', href: 'https://www.ptable.com/Element/Au' }],
    },
    {
      id: "Q10",
      difficulty: 'hard',
      ...
      correct: 'a',
      selected: null,
      links: [{ text: 'Olympics', href: 'https://www.olympic.org/athens-1896' }],
    },
  ],
  answers: [],
